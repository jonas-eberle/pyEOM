...
class Dataset(DatasetAbs):
    ...
    dir = '/MODIS_Dailies_D/MOLT/MOD11B1.005'
    sources = ['LPDAAC']
    ...
    bands = dict(Nighttime={
            'name': 'MODIS_Grid_Daily_6km_LST:LST_Night_6km',
            'nodata': 0,
            'scale': 0.02,
            'offset': None,
            'imagetype': 'physicalMeasurement',

            'identifier': 'MODIS_MOD11_B1_LST_Night_Series',
            ...
            'name': 'MODIS_Grid_Daily_6km_LST:LST_Day_6km',
            'nodata': 0,
            'scale': 0.02,
            'offset': None,
            'imagetype': 'physicalMeasurement',

            'identifier': 'MODIS_MOD11_B1_LST_Day_Series',
