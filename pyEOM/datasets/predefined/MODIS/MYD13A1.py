...
class Dataset(DatasetAbs):
    ...
    dir = '/MODIS_Composites/MOLA/MYD13A1.005'
    sources = ['LPDAAC']
    ...
    bands = dict(NDVI={
            ...
            'identifier': 'MODIS_MYD13_A1_EVI_Series',
            'title': '16-daily Enhanced Vegetation Index from MODIS Aqua',
            'abstract': 'Time-series of 16-daily Aqua MODIS Enhanced Vegetation Index (EVI) at 500 m spatial resolution. To retrieve actual values a scale factor of 0.0001 has to be applied. The unscaled nodata value is encoded as 0. Original MODIS data retrieved from the Land Processes Distributed Active Archive Center (ftp://e4ftl01.cr.usgs.gov/MOLT/).',
