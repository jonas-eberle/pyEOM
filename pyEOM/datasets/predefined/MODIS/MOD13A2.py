...
class Dataset(DatasetAbs):
    ...
    dir = '/MODIS_Composites/MOLT/MOD13A2.005'
    sources = ['LPDAAC']
    ...
    bands = dict(EVI={
            ...
            'identifier': 'MODIS_MOD13_A2_NDVI_Series',
            'title': '16-daily Normalized Difference Vegetation Index from MODIS Terra',
            'abstract': 'Time-series of 16-daily Terra MODIS Normalized Difference Vegetation Index (NDVI) at 1 km spatial resolution. To retrieve actual values a scale factor of 0.0001 has to be applied. The unscaled nodata value is encoded as 0. Original MODIS data retrieved from the Land Processes Distributed Active Archive Center (ftp://e4ftl01.cr.usgs.gov/MOLT/).',
