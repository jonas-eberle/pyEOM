...
class Dataset(DatasetAbs):
    ...
    dir = '/MODIS_Composites/MOLT/MOD13A3.005'
    sources = ['LPDAAC']
    ...
    bands = dict(NDVI={
            ...
            'identifier': 'MODIS_MOD13_A3_EVI_Series',
            'title': 'Monthly Enhanced Vegetation Index from MODIS Terra',
            'abstract': 'Time-series of monthly Terra MODIS Enhanced Vegetation Index (EVI) at 1 km spatial resolution. To retrieve actual values a scale factor of 0.0001 has to be applied. The unscaled nodata value is encoded as 0. Original MODIS data retrieved from the Land Processes Distributed Active Archive Center (ftp://e4ftl01.cr.usgs.gov/MOLT/).',
